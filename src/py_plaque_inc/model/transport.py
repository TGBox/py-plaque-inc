...
REGIONAL_ROUTES = {
    ...
    "chl": ["arg", "bol", "per", "aus"],
    "deu": ["fra", "gbr", "usa", "rus", "chn", "ita", "pol"],
    "fra": ["gbr", "deu", "esp", "ita", "usa", "bra"],
    "esp": ["fra", "nab", "bra", "gbr", "ita"],
    "ita": ["fra", "deu", "bal", "egy", "nab"],
    "pol": ["deu", "bal", "ukr", "fin", "rus"],
    "bal": ["ita", "deu", "pol", "ukr", "tur", "egy"],
    "sca": ["fin", "rus", "deu", "gbr", "isl"],
    "fin": ["sca", "pol", "rus", "ukr"],
