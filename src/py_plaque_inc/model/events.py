...
COUNTRY_SATIRE: Dict[str, str] = {
    ...
    "ceu": "Zentraleuropa: Schweizer Banken lagern Viren im Tresor ein, während Wien Sachertorte zur Nervenberuhigung serviert.",
    ...
    "blt": "Baltikum: Estland stellt die gesamte Seuchenquarantäne binnen Sekunden auf Blockchain und E-Governance um.",
